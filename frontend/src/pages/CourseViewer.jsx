...
export const CourseViewer = () => {
  ...
  const progress = getCourseProgress(courseId, course);
          ...
          onStateChange: (event) => {
            ...
            if (event.data === 0) {
              ...
              if (!autoCompletedRef.current && currentLessonData && currentModuleData) {
                ...
                if (!already) {
                  markVideoCompleted(courseId, currentModuleData.id, currentLessonData.id, course);
                  toast.success('Video completed! 🎉');
                  const updatedProgress = getCourseProgress(courseId, course);
