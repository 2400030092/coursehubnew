...
export const ProgressProvider = ({ children }) => {
  ...
  const markVideoCompleted = (courseId, moduleId, lessonId, courseOverride = null) => {
    setProgressData(prev => {
      ...
      const course = courseOverride || getCourseById(courseId);
  ...
  const getCourseProgress = (courseId, courseOverride = null) => {
    const course = courseOverride || getCourseById(courseId);
